            ...
            <div className="projets--card">
                ...
                <div className="projets--card__content">
                    ...
                    <div className="card--content__link">
                        <a href="https://kidozanges.netlify.app" target="_blank">Lien vers le site</a>
                        <a href="#">Github back</a>
                        <a href="#">Github front</a>
                    </div>
                </div>
            </div>
            <div className="projets--card">
                ...
                <div className="projets--card__content">
                    ...
                    <div className="card--content__link">
                        ...
                        <a href="https://github.com/FabienNaveau/Portfolio" target="_blank">Github</a>
                    </div>
                </div>
            </div>
        </section>
